...
void setup() {
  ...
  // esphome:
  //   name: esp8622-1
  //   build_path: .esphome/build/esp8622-1
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  //   min_version: 2022.12.6
  App.pre_setup("esp8622-1", __DATE__ ", " __TIME__, false);
  // logger:
  //   id: logger_logger
  //   baud_rate: 115200
  //   tx_buffer_size: 512
  ...
  // wifi:
  //   ap:
  //     ssid: Esp8622-1 Fallback Hotspot
  //     password: HauQh3WCXpiB
  //     id: wifi_wifiap
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_2
  //     priority: 0.0
  //   use_address: esp8622-1.local
  wifi_wificomponent = new wifi::WiFiComponent();
  wifi_wificomponent->set_use_address("esp8622-1.local");
  {
  ...
  wifi_wifiap.set_ssid("Esp8622-1 Fallback Hotspot");
  wifi_wifiap.set_password("HauQh3WCXpiB");
  ...
  // ota:
  //   password: 70ea4c4e2035ef6b648f9a4fede2c5aa
  //   id: ota_otacomponent
  //   safe_mode: true
  //   port: 8266
  //   reboot_timeout: 5min
  ...
  ota_otacomponent->set_auth_password("70ea4c4e2035ef6b648f9a4fede2c5aa");
  ota_otacomponent->set_component_source("ota");
  App.register_component(ota_otacomponent);
  if (ota_otacomponent->should_enter_safe_mode(10, 300000)) return;
  // api:
  //   encryption:
  //     key: bYuf1pBErkjFr9N2woQedvNRMuJV0IxxhLDF+6o7GF4=
  //   id: api_apiserver
  //   port: 6053
  //   password: ''
  //   reboot_timeout: 15min
  ...
  api_apiserver->set_noise_psk({109, 139, 159, 214, 144, 68, 174, 72, 197, 175, 211, 118, 194, 132, 30, 118, 243, 81, 50, 226, 85, 208, 140, 113, 132, 176, 197, 251, 170, 59, 24, 94});
  // preferences:
