...
void setup() {
  ...
  // esphome:
  //   name: nextion_cuisine
  //   build_path: .esphome/build/nextion_cuisine
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  //   min_version: 2022.12.8
  App.pre_setup("nextion_cuisine", __DATE__ ", " __TIME__, false);
  // binary_sensor:
  // display:
  // switch:
  // text_sensor:
  ...
  nextion1->set_writer([=](nextion::Nextion & it) -> void {
      #line 97 "/config/esphome/test-nodemcu.yaml"
